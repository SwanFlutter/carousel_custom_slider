...
class _CustomCardTransformWidgetState extends State<CustomCardTransformWidget> {
    ...
    return AnimatedBuilder(
      ...
      builder: (context, child) {
        ...
        if (widget.pageController.position.haveDimensions) {
          ...
          value = (1 - (value.abs() * widget.widget.valueScalingFactor)).clamp(
            0.0,
            1.0,
          );
        ...
        return Center(
          child: SizedBox(
            height:
                widget.widget.customCurve.transform(value) *
                widget.widget.dynamicHeight,
            width:
                Curves.easeInOutBack.transform(value) *
  ...
  Matrix4 getTransformMatrix(TransformType transformType) {
