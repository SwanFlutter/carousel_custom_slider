...
/// )
/// ```
class SimplePageWidget extends StatefulWidget {
  ...
  @override
  State<SimplePageWidget> createState() => _SimplePageWidgetState();
}

class _SimplePageWidgetState extends State<SimplePageWidget> {
